// Version 1.40.1 three-forcegraph - https://github.com/vasturiano/three-forcegraph
(function (global, factory) {
  ...
  var ngraph_forcelayoutExports = {};
  var ngraph_forcelayout = {
    get exports(){ return ngraph_forcelayoutExports; },
    set exports(v){ ngraph_forcelayoutExports = v; },
  };

  var generateCreateBodyExports = {};
  var generateCreateBody = {
    get exports(){ return generateCreateBodyExports; },
    set exports(v){ generateCreateBodyExports = v; },
  };
  ...
  generateCreateBodyExports.generateCreateBodyFunctionBody = generateCreateBodyFunctionBody;

  // InlineTransform: getVectorCode
  generateCreateBodyExports.getVectorCode = getVectorCode;
  // InlineTransform: getBodyCode
  generateCreateBodyExports.getBodyCode = getBodyCode;
...
Object.defineProperty(this, '{var}', {\n\
  ...
  var generateQuadTreeExports = {};
  var generateQuadTree = {
    get exports(){ return generateQuadTreeExports; },
    set exports(v){ generateQuadTreeExports = v; },
  };
  ...
  generateQuadTreeExports.generateQuadTreeFunctionBody = generateQuadTreeFunctionBody;

  // These exports are for InlineTransform tool.
  // InlineTransform: getInsertStackCode
  generateQuadTreeExports.getInsertStackCode = getInsertStackCode;
  // InlineTransform: getQuadNodeCode
  generateQuadTreeExports.getQuadNodeCode = getQuadNodeCode;
  // InlineTransform: isSamePosition
  generateQuadTreeExports.isSamePosition = isSamePosition;
  // InlineTransform: getChildBodyCode
  generateQuadTreeExports.getChildBodyCode = getChildBodyCode;
  // InlineTransform: setChildBodyCode
  generateQuadTreeExports.setChildBodyCode = setChildBodyCode;
...
`;
  ...
  var generateBoundsExports = {};
  var generateBounds = {
    get exports(){ return generateBoundsExports; },
    set exports(v){ generateBoundsExports = v; },
  };

  generateBounds.exports = generateBoundsFunction$1;
  generateBoundsExports.generateFunctionBody = generateBoundsFunctionBody;
...
`;
  ...
  var generateCreateDragForceExports = {};
  var generateCreateDragForce = {
    get exports(){ return generateCreateDragForceExports; },
    set exports(v){ generateCreateDragForceExports = v; },
  };

  const createPatternBuilder$2 = createPatternBuilder$6;

  generateCreateDragForce.exports = generateCreateDragForceFunction$1;
  generateCreateDragForceExports.generateCreateDragForceFunctionBody = generateCreateDragForceFunctionBody;
...
`;
  ...
  var generateCreateSpringForceExports = {};
  var generateCreateSpringForce = {
    get exports(){ return generateCreateSpringForceExports; },
    set exports(v){ generateCreateSpringForceExports = v; },
  };

  const createPatternBuilder$1 = createPatternBuilder$6;

  generateCreateSpringForce.exports = generateCreateSpringForceFunction$1;
  generateCreateSpringForceExports.generateCreateSpringForceFunctionBody = generateCreateSpringForceFunctionBody;
...
`;
  ...
  var generateIntegrator = {
    get exports(){ return generateIntegratorExports; },
    set exports(v){ generateIntegratorExports = v; },
  };

  const createPatternBuilder = createPatternBuilder$6;

  generateIntegrator.exports = generateIntegratorFunction$1;
  generateIntegratorExports.generateIntegratorFunctionBody = generateIntegratorFunctionBody;
...
`;
  ...
  var ngraph_randomExports = {};
  var ngraph_random = {
    get exports(){ return ngraph_randomExports; },
    set exports(v){ ngraph_randomExports = v; },
  };

  var hasRequiredNgraph_random;

  function requireNgraph_random () {
  	if (hasRequiredNgraph_random) return ngraph_randomExports;
  	hasRequiredNgraph_random = 1;
  	ngraph_random.exports = random;

  	// TODO: Deprecate?
  	ngraph_randomExports.random = random,
  	ngraph_randomExports.randomIterator = randomIterator;
  ...
  ngraph_forcelayoutExports.simulator = createPhysicsSimulator_1;
  ...
  var ngraph = {
    graph: ngraph_graph,
    forcelayout: ngraph_forcelayoutExports
  };
